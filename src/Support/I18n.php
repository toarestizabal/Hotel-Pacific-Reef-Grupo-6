...
final class I18n
{
    ...
    private static function englishDictionary(): array
    {
        return [
            ...
            'La reserva fue registrada correctamente. Guarda el código para identificarla.' => 'The booking was registered successfully. Keep the code to identify it.',
            ...
            'El pago fue procesado en el ambiente de prueba. El ticket con código QR y la notificación por correo se completarán en HU-08.' => 'The payment was processed in the test environment. The QR ticket and email notification will be completed in HU-08.',
